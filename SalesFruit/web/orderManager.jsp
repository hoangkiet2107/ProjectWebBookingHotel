...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div>
                <a href="ManagerProduct.jsp" style="color: black">PRODUCT MANAGER</a>
                <table class="table table-bordered table-hover" >
                    ...
                    <tr style="background: #4d72de">
                        ...
                        <th>Edit</th>
                        <th>Delete</th>
                        <th><a href="addNewOrder.jsp" style="color: black">ADD NEW</a></th>
                    </tr>
                    </thead>
                    <tbody>
                        <%
                        ...
                        <tr>
                            ...
                            <td><%=status%></td>
                            <td><a href="updateOrder.jsp?id=<%=list.get(i).getOrderID()%>">Edit</a></td>
                            <td><a href="deleteOrder.jsp?id=<%=list.get(i).getOrderID()%>">Delete</a></td>
                        </tr>
                        <%
                            }
                        %>
